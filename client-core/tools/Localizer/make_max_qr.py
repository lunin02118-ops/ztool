...
tx = 300
lines = [
    ("Свяжитесь со мной в MAX", font(40, True), (0, 0, 0)),
    ("Владимир Игоревич", font(34, False), (0, 0, 0)),
    ("+7 705 803 0863", font(32, False), (20, 90, 200)),
    ("Отсканируйте QR или нажмите «Max»", font(24, False), (110, 110, 110)),
]
# vertical layout
gap = 14
heights = []
