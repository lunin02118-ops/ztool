...
{
	[CompilerGenerated]
	internal class _Closure_0024__91
	{
		public Rectangle _0024VB_0024Local_Rect;

		public DataGridViewEX _0024VB_0024Me;

		[DebuggerNonUserCode]
		public _Closure_0024__91()
		{
		}

		[DebuggerNonUserCode]
		public _Closure_0024__91(_Closure_0024__91 other)
		{
			if (other != null)
			{
				_0024VB_0024Local_Rect = other._0024VB_0024Local_Rect;
		...
		[SpecialName]
		[CompilerGenerated]
		public Point _Lambda_0024__149(Point p)
		{
			return checked(new Point((int)Math.Round((double)_0024VB_0024Local_Rect.Right + (double)p.X * _0024VB_0024Me.dpixRatio), (int)Math.Round((double)_0024VB_0024Local_Rect.Top + (double)p.Y * _0024VB_0024Me.dpixRatio)));
		}
	}
	...
	{
		_Closure_0024__91 closure_0024__ = new _Closure_0024__91();
		closure_0024__._0024VB_0024Local_Rect = Rect;
		...
		e.Graphics.FillRectangle(cachedBrush, closure_0024__._0024VB_0024Local_Rect);
		...
		if (col == e.ColumnIndex)
		{
			...
			if (_sortArrowPoints.ContainsKey(key))
			{
				...
				Point[] points = source.Select(closure_0024__._Lambda_0024__149).ToArray();
		...
		{
			DrawFilterButton(e, closure_0024__._0024VB_0024Local_Rect);
		}
		e.Handled = true;
	}
