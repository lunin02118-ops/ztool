...
public class FrmFileList : Form
{
	...
	internal class _Closure_0024__35
	{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__72(string s)
		{
			return s.EndsWith(_0024VB_0024Local_str, StringComparison.OrdinalIgnoreCase);
		}
	}
	...
	private void openinsw_Click(object sender, EventArgs e)
	{
		try
		{
			...
			if (File.Exists(text))
			{
				Thread thread = new Thread(_Lambda_0024__73);
				thread.Start(text);
			}
		}
		catch (Exception ex)
	...
	[DebuggerStepThrough]
	[CompilerGenerated]
	private static void _Lambda_0024__73(object a0)
	{
