...
public class FrmRename : Form
{
	...
	{
		[CompilerGenerated]
		internal class _Closure_0024__87
		{
			public string _0024VB_0024Local_findstr3;

			[DebuggerNonUserCode]
			public _Closure_0024__87()
			{
			}

			[DebuggerNonUserCode]
			public _Closure_0024__87(_Closure_0024__87 other)
			{
				if (other != null)
				{
			...
			[SpecialName]
			[CompilerGenerated]
			public bool _Lambda_0024__145(string s1)
			{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__144(string val)
		{
			return val.Equals(_0024VB_0024Local_oldpathname, StringComparison.OrdinalIgnoreCase);
		}
	}
	...
	internal class _Closure_0024__88
	{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__146(string s)
		{
				...
				while (true)
				{
					...
					if (!list.Exists(closure_0024__._Lambda_0024__144) && (!ByCheck.Checked || flag) && 0 == 0 && (!ByFilter.Checked || MyProject.Forms.Frmmain.DGV1.Rows[num7].Visible) && 0 == 0 && (!ByRuler.Checked || customFilter.FilterByRule(num7) != Excludebyruler.Checked) && 0 == 0)
					{
						...
						while (true)
						{
							...
							{
								_Closure_0024__86._Closure_0024__87 closure_0024__2 = new _Closure_0024__86._Closure_0024__87();
								closure_0024__2._0024VB_0024Local_findstr3 = "<" + MyProject.Forms.Frmmain.DGV1.Columns[num10].HeaderText + ">";
								if (vallist.Exists(closure_0024__2._Lambda_0024__145))
								{
									text4 = text4.Replace(closure_0024__2._0024VB_0024Local_findstr3, Convert.ToString(RuntimeHelpers.GetObjectValue(MyProject.Forms.Frmmain.DGV1[num10, num7].Value)));
								}
							}
							num10++;
						}
						string text5 = code.MidStrEx(text4, "{", "}");
						if (Versioned.IsNumeric(text5))
						{
							text2 = text4.Replace("{" + text5 + "}", "{" + (Conversions.ToDouble(text5) + (double)num).ToString().PadLeft(text5.Length, '0') + "}");
							text4 = text4.Replace("{" + text5 + "}", (Conversions.ToDouble(text5) + (double)num).ToString().PadLeft(text5.Length, '0'));
						}
						...
						while (true)
						{
							if (dgvdata2.index > 0)
							{
								...
								text5 = code.MidStrEx(text2, "{", "}");
								if (Versioned.IsNumeric(text5))
								{
									num = Convert.ToInt32(decimal.Add(new decimal(num), NumericUpDown1.Value));
									stringBuilder.Append(text4 + ";");
									text2 = text2.Replace("{" + text5 + "}", "{" + (Conversions.ToDouble(text5) + Convert.ToDouble(NumericUpDown1.Value)).ToString().PadLeft(text5.Length, '0') + "}");
									string text6 = code.MidStrEx(text2, "{", "}");
									text4 = text2.Replace("{" + text6 + "}", text6);
							...
							if (Operators.CompareString(text4, "", TextCompare: false) != 0)
							{
								...
								string text8 = code.MidStrEx(text, "{", "}");
								Label8.Text = text.Replace("{" + text8 + "}", "{" + text7 + "}");
								num = Convert.ToInt32(decimal.Add(new decimal(num), NumericUpDown1.Value));
							}
							break;
						}
