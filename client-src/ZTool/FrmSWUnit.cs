...
public class FrmSWUnit : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.Unit_IPS.Text = "IPS (дюйм, фунт, секунда)";
		...
		this.Unit_MMGS.Text = "MMGS (миллиметр, грамм, секунда)";
		...
		this.Unit_CGS.Text = "CGS (сантиметр, грамм, секунда)";
		...
		this.Unit_MMKS.Text = "MMKS (миллиметр, килограмм, секунда)";
		...
		this.Unit_MKS.Text = "MKS (метр, килограмм, секунда)";
		...
		this.Label3.Text = "Длина (двойной размер)";
		...
		this.Label7.Text = "Единица объёма";
