...
public class FrmSetDrwOption : Form
{
	...
	private void OK_Button_Click(object sender, EventArgs e)
	{
		...
		checked
		{
			try
			{
				...
				if ((CheckBox2.Checked && flag5 && filelist.Exists(_Lambda_0024__40)) ? true : false)
				{
				...
				{
					if (filelist.Exists(_Lambda_0024__41))
					{
					...
					if (filelist.Exists(_Lambda_0024__42))
					{
					...
					if (filelist.Exists(_Lambda_0024__43))
					{
				...
				if (((!CheckBox1.Checked && !CheckBox2.Checked && !filelist.Exists(_Lambda_0024__44)) ? true : false) && filelist.Count > 0)
				{
					Interaction.MsgBox("Нет файлов для обработки!", MsgBoxStyle.Information, "Информация");
					return;
				}
	...
	[SpecialName]
	[CompilerGenerated]
	private static bool _Lambda_0024__40(string s)
	{
		return s.EndsWith(".slddrw", StringComparison.OrdinalIgnoreCase);
	}

	[SpecialName]
	[CompilerGenerated]
	private static bool _Lambda_0024__41(string s)
	{
		return s.EndsWith(".slddrw", StringComparison.OrdinalIgnoreCase);
	}
	...
	[SpecialName]
	[CompilerGenerated]
	private static bool _Lambda_0024__42(string s)
	{
		return s.EndsWith(".sldprt", StringComparison.OrdinalIgnoreCase);
	}

	[SpecialName]
	[CompilerGenerated]
	private static bool _Lambda_0024__43(string s)
	{
		return s.EndsWith(".sldasm", StringComparison.OrdinalIgnoreCase);
	}

	[SpecialName]
	[CompilerGenerated]
	private static bool _Lambda_0024__44(string s)
	{
		return s.EndsWith(".slddrw", StringComparison.OrdinalIgnoreCase);
	}
}
