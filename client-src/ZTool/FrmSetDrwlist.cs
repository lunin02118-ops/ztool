...
[DesignerGenerated]
public class FrmSetDrwlist : Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ZTool.FrmSetDrwlist));
		...
		System.Drawing.Size size = new System.Drawing.Size(300, 16);
		...
		System.Windows.Forms.Padding margin = new System.Windows.Forms.Padding(0, 1, 20, 2);
		...
		toolStripButton4.Margin = margin;
		...
		margin = new System.Windows.Forms.Padding(12, 6, 12, 12);
		groupBox2.Padding = margin;
		...
		margin = new System.Windows.Forms.Padding(5, 0, 0, 0);
		toolStripSeparator3.Margin = margin;
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem3 = this.addselformSW;
		size = new System.Drawing.Size(292, 22);
		toolStripMenuItem3.Size = size;
		this.addselformSW.Text = "Загрузить выбранные элементы сборки";
		this.addallformSW.Image = ZTool.My.Resources.Resources.SW_32px;
		this.addallformSW.Name = "addallformSW";
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem4 = this.addallformSW;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem5 = this.addprtformSW;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem7 = this.adddrawformSW;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem8 = this.addfilesformfolder1;
		size = new System.Drawing.Size(292, 22);
		...
		this.addfiles.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[19]
		{
			this.addfilesformfolder1, this.AddFromMain, this.adddrawformSW, this.adddrawformPrt, this.addprtformSW, this.addallformSW, this.addselformSW, this.adddrwformsel, this.ToolStripSeparator3, this.addprtfromcurasm,
			this.addprtfromcurasm2, this.adddrwfromprtincurasm, this.addprtanddrwfromprtincurasm, this.addprtfromspeasm, this.addprtfromspeasm2, this.adddrwfromprtinspeasm, this.addprtanddrwfromprtinspeasm, this.ToolStripSeparator7, this.adddrwformactive
		});
		...
		toolStripSplitButton.Margin = margin;
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem9 = this.adddrwformsel;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem10 = this.addprtfromcurasm;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem11 = this.addprtfromcurasm2;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem12 = this.adddrwfromprtincurasm;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem13 = this.addprtanddrwfromprtincurasm;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem14 = this.addprtfromspeasm;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem15 = this.addprtfromspeasm2;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem16 = this.adddrwfromprtinspeasm;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem17 = this.addprtanddrwfromprtinspeasm;
		size = new System.Drawing.Size(292, 22);
		...
		System.Windows.Forms.ToolStripMenuItem toolStripMenuItem18 = this.adddrwformactive;
		size = new System.Drawing.Size(292, 22);
		...
		this.ToolStrip1.Items.AddRange(new System.Windows.Forms.ToolStripItem[8] { this.addfiles, this.ToolStripSeparator2, this.clearsel, this.clearall, this.copyitem, this.pasteitem, this.ToolStripSeparator1, this.nextstep });
		...
		this.Tag = "Замена формата листа и стандарта оформления";
		this.Text = "Замена формата листа и стандарта оформления";
	...
	public FrmSetDrwlist()
	{
		base.FormClosed += FrmSetDrwformat_FormClosed;
		base.Load += FrmSetDrwformat_Load;
		__ENCAddToList(this);
		dpixRatio = 1.0;
		InitializeComponent();
	...
	private void FrmSetDrwformat_FormClosed(object sender, FormClosedEventArgs e)
	{
		Switch(0);
		MyProject.Forms.FrmSetDrwOption.SetDrwBgWorker.Dispose();
		Dispose();
		try
		{
			MyProject.Forms.FrmSetDrwOption.Dispose();
	...
	private void FrmSetDrwformat_Load(object sender, EventArgs e)
	{
		try
		{
			SR sR = new SR();
		...
		checked
		{
			...
			int num4 = (int)Math.Round(50.0 * dpixRatio);
	...
	public void loadview(List<string> f)
	{
		...
		checked
		{
			...
			while (true)
			{
				...
				num11++;
				if ((code.TMode && num11 > 10) ? true : false)
				{
	...
	private void addselformSW_Click(object sender, EventArgs e)
	{
		...
		while (true)
		{
			...
			{
				list.Add(Conversions.ToString(NewLateBinding.LateGet(objectValue3, null, "GetPathName", new object[0], null, null, null)));
			}
			num3 = checked(num3 + 1);
		}
		NewLateBinding.LateSet(code.swApp, null, "CommandInProgress", new object[1] { false }, null, null);
	...
	private void nextstep_Click(object sender, EventArgs e)
	{
		...
		{
			MyProject.Forms.FrmSetDrwOption.ShowDialog();
		}
		else
		{
			Switch(0);
	...
	{
		MyProject.Forms.FrmSetDrwOption.SetDrwBgWorker.WorkerSupportsCancellation = true;
		switch (@int)
		{
		case 0:
			MyProject.Forms.FrmSetDrwOption.SetDrwBgWorker.CancelAsync();
	...
	private void openinsw_Click(object sender, EventArgs e)
	{
		try
		{
			...
			if (File.Exists(text))
			{
				Thread thread = new Thread(_Lambda_0024__39);
				thread.Start(text);
			}
		}
		catch (Exception ex)
	...
	[CompilerGenerated]
	[DebuggerStepThrough]
	private static void _Lambda_0024__39(object a0)
	{
