...
{
	[CompilerGenerated]
	internal class _Closure_0024__89
	{
		public string _0024VB_0024Local_name;

		[DebuggerNonUserCode]
		public _Closure_0024__89()
		{
		}

		[DebuggerNonUserCode]
		public _Closure_0024__89(_Closure_0024__89 other)
		{
			if (other != null)
			{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__147(DataGridViewRow r)
		{
			return r.Cells[0].Value.ToString().Equals(_0024VB_0024Local_name, StringComparison.Ordinal);
		}
	}
	...
	{
		_Closure_0024__89 closure_0024__ = new _Closure_0024__89();
		closure_0024__._0024VB_0024Local_name = name;
		string result = "";
		try
		{
			DataGridViewRow dataGridViewRow = dgv.Rows.Cast<DataGridViewRow>().Where(closure_0024__._Lambda_0024__147).First();
