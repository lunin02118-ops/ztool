...
public class Frmcompare : Form
{
	...
	internal class _Closure_0024__75
	{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__132(DataGridViewRow r)
		{
			return Convert.ToString(RuntimeHelpers.GetObjectValue(r.Cells[MyProject.Forms.Frmmain.Col_Number.Index].Value)).Equals(_0024VB_0024Local_rownumber.ToString(), StringComparison.CurrentCultureIgnoreCase);
		}
	}
	...
	internal class _Closure_0024__76
	{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__133(DataGridViewRow r)
		{
			return Convert.ToString(RuntimeHelpers.GetObjectValue(r.Cells[MyProject.Forms.Frmmain.Col_Number.Index].Value)).Equals(_0024VB_0024Local_rownumber.ToString(), StringComparison.CurrentCultureIgnoreCase);
		}
	}
