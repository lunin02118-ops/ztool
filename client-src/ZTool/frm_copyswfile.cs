...
public class frm_copyswfile : Form
{
	...
	internal class _Closure_0024__7
	{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__9(string s)
		{
	...
	internal class _Closure_0024__8
	{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__10(swfile s)
		{
			return s.oldname.Equals(_0024VB_0024Local_oldpathname, StringComparison.OrdinalIgnoreCase);
		}
	}

	[CompilerGenerated]
	internal class _Closure_0024__9
	{
		public int _0024VB_0024Local_i;

		[DebuggerNonUserCode]
		public _Closure_0024__9()
		{
		}

		[DebuggerNonUserCode]
		public _Closure_0024__9(_Closure_0024__9 other)
		{
			if (other != null)
			{
		...
		[SpecialName]
		[CompilerGenerated]
		public void _Lambda_0024__12()
		{
			MyProject.Forms.Frmmain.ToolStripProgressBar1.Value = checked(_0024VB_0024Local_i + 1);
		}

		[SpecialName]
		[CompilerGenerated]
		public void _Lambda_0024__14()
		{
			MyProject.Forms.Frmmain.ToolStripProgressBar1.Value = checked(_0024VB_0024Local_i + 1);
		}
	}
	...
	{
		_Closure_0024__9 closure_0024__ = new _Closure_0024__9();
		bool flag = false;
		StringBuilder stringBuilder = new StringBuilder();
		code.Dostop = false;
		Stopwatch stopwatch = new Stopwatch();
		stopwatch.Restart();
		ControlExtensions.InvokeOnUiThreadIfRequired(this, _Lambda_0024__11);
		checked
		{
			...
			while (true)
			{
				...
				int num3 = num;
				if (num2 > num3 || code.Dostop || Abort)
				{
					break;
				}
				ControlExtensions.InvokeOnUiThreadIfRequired(this, closure_0024__._Lambda_0024__12);
				try
				{
					if (c_Include3d.Checked)
					{
						File.Copy(filelist[closure_0024__._0024VB_0024Local_i].oldname, filelist[closure_0024__._0024VB_0024Local_i].newname, overwrite);
						if (File.Exists(filelist[closure_0024__._0024VB_0024Local_i].newname))
						{
							File.SetAttributes(filelist[closure_0024__._0024VB_0024Local_i].newname, FileAttributes.Normal);
						}
					}
					int num4 = suffixlist.Count - 1;
					int num5 = 0;
					while (true)
					{
						int num6 = num5;
						...
						if (File.Exists(code.SplitStr(filelist[closure_0024__._0024VB_0024Local_i].oldname, 3) + suffixlist[num5]))
						{
							File.Copy(code.SplitStr(filelist[closure_0024__._0024VB_0024Local_i].oldname, 3) + suffixlist[num5], code.SplitStr(filelist[closure_0024__._0024VB_0024Local_i].newname, 3) + suffixlist[num5], overwrite);
							if (File.Exists(code.SplitStr(filelist[closure_0024__._0024VB_0024Local_i].newname, 3) + suffixlist[num5]))
							{
								File.SetAttributes(code.SplitStr(filelist[closure_0024__._0024VB_0024Local_i].newname, 3) + suffixlist[num5], FileAttributes.Normal);
							}
						}
						num5++;
					}
			...
			ControlExtensions.InvokeOnUiThreadIfRequired(this, _Lambda_0024__13);
			try
			{
				if (!code.RunSW())
				{
				...
				int num7 = filelist.Count - 1;
				closure_0024__._0024VB_0024Local_i = 0;
				while (true)
				{
					int num8 = closure_0024__._0024VB_0024Local_i;
					int num3 = num7;
					if (num8 > num3)
					{
						break;
					}
					ControlExtensions.InvokeOnUiThreadIfRequired(this, closure_0024__._Lambda_0024__14);
					...
					if (File.Exists(filelist[closure_0024__._0024VB_0024Local_i].newname))
					{
						string text = code.SplitStr(filelist[closure_0024__._0024VB_0024Local_i].newname, 3) + ".slddrw";
						if (File.Exists(text))
						{
							...
							{
								text,
								filelist[closure_0024__._0024VB_0024Local_i].oldname,
								filelist[closure_0024__._0024VB_0024Local_i].newname
							};
						...
						if (!Information.IsNothing(RuntimeHelpers.GetObjectValue(objectValue)))
						{
							...
							while (true)
							{
								...
								string text2 = NewLateBinding.LateIndexGet(objectValue, new object[1] { num10 + 1 }, null).ToString();
								int num12 = filelist.Count - 1;
								int num5 = 0;
								while (true)
								{
									int num13 = num5;
									...
									if (text2.Equals(filelist[num5].oldname, StringComparison.OrdinalIgnoreCase))
									{
										if (!Conversions.ToBoolean(NewLateBinding.LateGet(code.swApp, null, "ReplaceReferencedDocument", new object[3]
										{
											filelist[closure_0024__._0024VB_0024Local_i].newname,
											filelist[num5].oldname,
											filelist[num5].newname
										}, null, null, null)))
										{
											stringBuilder.AppendLine("\"" + filelist[closure_0024__._0024VB_0024Local_i].newname + "\" не удалось обновить ссылки!");
										}
										break;
									}
									num5++;
			...
			ControlExtensions.InvokeOnUiThreadIfRequired(this, _Lambda_0024__15);
			error_box.Clear();
