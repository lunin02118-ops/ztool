...
public class toolbox : Form
{
	...
	internal class _Closure_0024__2
	{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__3(box s)
		{
			return s.path.Equals(_0024VB_0024Local_p, StringComparison.OrdinalIgnoreCase);
		}
	}
	...
	internal class _Closure_0024__3
	{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__4(box s)
		{
			return s.path.Equals(_0024VB_0024Local_p, StringComparison.OrdinalIgnoreCase);
		}
	}
	...
	{
		public ListViewItem _0024VB_0024Local_draggedItem;

		public ListViewItem _0024VB_0024Local_TargetItem;
		...
		public _Closure_0024__4(_Closure_0024__4 other)
		{
			if (other != null)
			{
				_0024VB_0024Local_TargetItem = other._0024VB_0024Local_TargetItem;
				_0024VB_0024Local_draggedItem = other._0024VB_0024Local_draggedItem;
			}
		}

		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__5(box s)
		{
			return s.path.Equals(_0024VB_0024Local_draggedItem.SubItems[1].Text, StringComparison.OrdinalIgnoreCase);
		}

		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__6(box s)
		{
			return s.path.Equals(_0024VB_0024Local_TargetItem.SubItems[1].Text, StringComparison.OrdinalIgnoreCase);
		}
	}

	[CompilerGenerated]
	internal class _Closure_0024__5
	{
		public string _0024VB_0024Local_curpath;

		[DebuggerNonUserCode]
		public _Closure_0024__5()
		{
		}

		[DebuggerNonUserCode]
		public _Closure_0024__5(_Closure_0024__5 other)
		{
			if (other != null)
			{
				_0024VB_0024Local_curpath = other._0024VB_0024Local_curpath;
			}
		}

		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__7(box s)
		{
			return s.path.Equals(_0024VB_0024Local_curpath, StringComparison.OrdinalIgnoreCase);
		}
	}
	...
	internal class _Closure_0024__6
	{
		...
		[SpecialName]
		[CompilerGenerated]
		public bool _Lambda_0024__8(box s)
		{
			return s.path.Equals(_0024VB_0024Local_p, StringComparison.CurrentCultureIgnoreCase);
		}
	}
	...
	{
		_Closure_0024__4 closure_0024__ = new _Closure_0024__4();
		closure_0024__._0024VB_0024Local_draggedItem = (ListViewItem)e.Data.GetData(typeof(ListViewItem));
		Point p = new Point(e.X, e.Y);
		Point point = LV1.PointToClient(p);
		closure_0024__._0024VB_0024Local_TargetItem = (ListViewItem)LV1.GetItemAt(point.X, point.Y);
		if (!Information.IsNothing(closure_0024__._0024VB_0024Local_draggedItem) && !Information.IsNothing(closure_0024__._0024VB_0024Local_TargetItem) && 0 == 0)
		{
			box item = itemlist.Find(closure_0024__._Lambda_0024__5);
			itemlist.Remove(item);
			int index = itemlist.FindIndex(closure_0024__._Lambda_0024__6);
	...
	private void ListView1_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
	{
		try
		{
			_Closure_0024__5 closure_0024__ = new _Closure_0024__5();
			currow = LV1.SelectedIndices[0];
			closure_0024__._0024VB_0024Local_curpath = LV1.Items[currow].SubItems[1].Text;
			curbox = itemlist.Find(closure_0024__._Lambda_0024__7);
		}
		catch (Exception ex)
		{
			ProjectData.SetProjectError(ex);
