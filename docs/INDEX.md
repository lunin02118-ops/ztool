...
| [`production/LOCAL_ARTIFACTS_POLICY_RU.md`](production/LOCAL_ARTIFACTS_POLICY_RU.md) | Правила хранения локальных release artifacts, installers, evidence и secrets в `_local_artifacts/` | актуален |
