...
| R-011 | P1 | Localization pipeline может скрыть user-facing Han за whitelist или смешать source/runtime/help/installer/add-in debt. | Partially mitigated by Sprint H exact-whitelist gate and architecture debt docs: `SWTools.exe` scan PASS (`han_entries=78`, `unclassified_han=0`, diagnostics=0). Remaining: user visual audit of screenshots/help/installer before production GO or visual FULL PASS. | Sprint H |
