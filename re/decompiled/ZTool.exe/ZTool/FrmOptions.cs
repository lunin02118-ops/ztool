...
public class FrmOptions : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.Controls.Find("TabControl1", true)[0].Width = 760;
		this.Controls.Find("TabControl1", true)[0].Height = 500;
		this.Controls.Find("Label3", true)[0].Width = 120;
		this.Controls.Find("Label3", true)[0].Text = "Подсветка строк:";
		this.Controls.Find("Label1", true)[0].Width = 100;
		this.Controls.Find("Label1", true)[0].Text = "Версия SW:";
		this.Controls.Find("Label4", true)[0].Width = 145;
		this.Controls.Find("Label4", true)[0].Text = "Пакетные эскизы:";
		this.Controls.Find("PreviewMode", true)[0].Left = 180;
		this.Controls.Find("PreviewMode", true)[0].Width = 240;
		this.Controls.Find("Thumbnail_Savetolocal", true)[0].Width = 285;
		this.Controls.Find("Thumbnail_position", true)[0].Left = 315;
		this.Controls.Find("Thumbnail_position", true)[0].Width = 180;
		this.Controls.Find("Button3", true)[0].Width = 210;
		this.Controls.Find("Button7", true)[0].Left = 250;
		this.Controls.Find("Button7", true)[0].Width = 230;
		this.Controls.Find("macrolist", true)[0].Width = 590;
		this.Controls.Find("Panel3", true)[0].Left = 600;
		this.Controls.Find("Panel3", true)[0].Width = 150;
		this.Controls.Find("Button8", true)[0].Width = 130;
		this.Controls.Find("Button9", true)[0].Width = 130;
	}
	...
	private void addtosw_Click(object sender, EventArgs e)
	{
		...
		{
			string text = code.SplitStr(materialpath.Text).TrimEnd('\\', '/');
			string text2 = Conversions.ToString(NewLateBinding.LateGet(code.swApp, null, "GetUserPreferenceStringValue", new object[1] { 28 }, null, null, null));
			...
			if (!list.Exists([SpecialName] (string s) => s.Equals(text, StringComparison.OrdinalIgnoreCase)))
			{
				...
				object[] array = new object[2] { 28, text2 };
