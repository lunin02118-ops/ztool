...
public class FrmOutputoptions : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.MinimumSize = new System.Drawing.Size(449, 461);
	}
						...
						if (obj4 != null)
						{
							...
							if (swFileTYpe == 3)
							{
								...
								while (true)
								{
									...
									if ((!list.Exists([SpecialName] (string s) => (s.EndsWith(".png", StringComparison.OrdinalIgnoreCase) || s.EndsWith(".jpg", StringComparison.OrdinalIgnoreCase)) ? true : false) && (!list.Exists([SpecialName] (string s) => s.EndsWith(".pdf", StringComparison.OrdinalIgnoreCase)) || (Multiplesheet_pdf.SelectedIndex != 1 && Multiplesheet_pdf.SelectedIndex != 3 && (!add_watertext.Checked || Multiplesheet_pdf.SelectedIndex != 0))) && (!list.Exists([SpecialName] (string s) => (s.EndsWith(".dwg", StringComparison.OrdinalIgnoreCase) || s.EndsWith(".dxf", StringComparison.OrdinalIgnoreCase)) ? true : false) || (Multiplesheet_dwg.SelectedIndex != 1 && Multiplesheet_dwg.SelectedIndex != 3))) || 1 == 0)
									{
										break;
									}
									num9++;
