...
public class FrmReplacePartslist : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.Containssubfolders.Text = "Подпапки";
		...
		this.RadioButton1.Text = "Только верхний";
	...
	public void ReplaceReference()
	{
		...
		checked
		{
			try
			{
				_Closure_0024__15 closure_0024__2 = closure_0024__;
				if (!code.RunSW())
				{
					return;
				}
				...
				ControlExtensions.InvokeOnUiThreadIfRequired(this, [SpecialName] () =>
				{
					if (closure_0024__2._0024VB_0024Me.Abort)
					{
						closure_0024__2._0024VB_0024Me.ToolStripStatusLabel1.Text = "Задача отменена";
					}
					else
					{
						closure_0024__2._0024VB_0024Me.ToolStripStatusLabel1.Text = "Замена завершена";
						if (num6 > 0)
						{
							closure_0024__2._0024VB_0024Me.ListView2.Items[closure_0024__2._0024VB_0024Me.selrow].ForeColor = Color.Green;
							int num12 = 0;
							int num13 = closure_0024__2._0024VB_0024Me.ListView2.Items.Count - 1;
							int num14 = 0;
							while (true)
							{
								int num15 = num14;
								...
								if (!File.Exists(closure_0024__2._0024VB_0024Me.ListView2.Items[num14 - num12].SubItems[2].Text))
								{
									closure_0024__2._0024VB_0024Me.ListView2.DelSpecificItems(num14 - num12);
									num12++;
								}
								num14++;
							}
					...
					closure_0024__2._0024VB_0024Me.OK_Button.Text = "Старт";
					closure_0024__2._0024VB_0024Me.ToolStripProgressBar1.Value = 0;
					closure_0024__2._0024VB_0024Me.ToolStripProgressBar1.Visible = false;
					closure_0024__2._0024VB_0024Me.Abort = true;
	...
	public void setdownlist()
	{
		...
		checked
		{
			...
			else
			{
				...
				string text = lvi1[currow].SubItems[1].Text;
				string value = code.SplitStr(text, 4);
				List<string> list = f.FindAll([SpecialName] (string s) => (s.EndsWith(value) && string.Compare(s, text, ignoreCase: true) != 0) ? true : false);
				if (list.Count <= 0)
				{
					return;
				}
	...
	private void ListView1_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
	{
		checked
		{
			try
			{
				...
				customComboBox.Click += [SpecialName] [DebuggerStepThrough] (object a0, EventArgs a1) =>
				{
