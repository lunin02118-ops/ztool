...
public class Frmmapping : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.Controls.Find("DGV1", true)[0].Width = 760;
		this.Controls.Find("DGV1", true)[0].Height = 360;
		this.Controls.Find("Label1", true)[0].Top = 380;
		this.Controls.Find("Label1", true)[0].Width = 760;
		this.Controls.Find("Label1", true)[0].Height = 80;
	}
		...
		checked
		{
			try
			{
				...
				while (true)
				{
					...
					bool flag = !MyProject.Forms.Frmmain.DGV1.Columns[num3].Name.Contains("PropVal_");
					if (flag && (MyProject.Forms.Frmmain.DGV1.Columns[num3].Name.Equals("Col_Weight", StringComparison.OrdinalIgnoreCase) || MyProject.Forms.Frmmain.DGV1.Columns[num3].Name.Equals("Col_bound", StringComparison.OrdinalIgnoreCase)))
					{
						flag = false;
					}
					if (!flag)
