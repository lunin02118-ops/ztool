...
public class Frmsetpropname : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.MinimumSize = new System.Drawing.Size(322, 402);
	}
		...
		checked
		{
			...
			while (true)
			{
				...
				try
				{
					...
					{
						string value = Elements.ElementAtOrDefault(num2).Attribute("PropName").Value;
						if (Information.IsNothing(arr) || !arr.Exists([SpecialName] (string s) => s.Equals(value, StringComparison.OrdinalIgnoreCase)))
						{
							arr.Add(value);
						}
					}
