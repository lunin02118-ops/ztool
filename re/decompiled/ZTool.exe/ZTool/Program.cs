...
internal sealed class Program
{
	...
	public static void Main(string[] args)
	{
		...
		AppDomain.CurrentDomain.AssemblyResolve += [SpecialName] [DebuggerStepThrough] (object a0, ResolveEventArgs a1) => (Assembly)CurrentDomain_AssemblyResolve(RuntimeHelpers.GetObjectValue(a0), a1);
	...
	public static object CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
	{
		...
		string name = Array.Find(Assembly.GetExecutingAssembly().GetManifestResourceNames(), [SpecialName] (string element) => element.EndsWith(value));
