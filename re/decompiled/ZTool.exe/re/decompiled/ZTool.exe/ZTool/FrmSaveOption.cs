...
public class FrmSaveOption : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.Save_Changed.Text = "Только изменённые";
		...
		this.Save_Failed.Text = "Несохранённые";
		...
		this.CheckBox10.Text = "Автосохранение после изменений";
		...
		this.CheckBox2.Text = "Сохранять пустые свойства";
		...
		this.CheckBox1.Text = "и удалить лишние свойства";
		...
		this.ComboBox1.Items.AddRange(new object[4] { "Исходное (настраиваемые)", "Исходное (конфигурация)", "Пользовательское", "Текущая конфигурация" });
		...
		this.Label2.Text = "После переименования старые файлы:";
		...
		this.CheckBox7.Text = "Пропускать read-only файлы";
		...
		this.CheckBox4.Text = "Перезаписывать файлы";
		...
		this.LinkLabel2.Text = "Настройки";
		...
		this.Controls.Find("GroupBox1", true)[0].Width = 340;
		this.Controls.Find("ComboBox1", true)[0].Width = 318;
		this.Controls.Find("ComboBox2", true)[0].Width = 318;
		this.Controls.Find("ComboBox3", true)[0].Width = 318;
		this.Controls.Find("ComboBox4", true)[0].Width = 318;
		this.Controls.Find("CheckBox9", true)[0].Width = 300;
		this.Controls.Find("CheckBox9", true)[0].Text = "и удалить из сл. расположения";
		this.Controls.Find("CheckBox1", true)[0].Width = 300;
		this.Controls.Find("CheckBox2", true)[0].Width = 250;
		this.Controls.Find("CheckBox2", true)[0].Text = "Сохранять пустые";
		this.Controls.Find("CheckBox3", true)[0].Width = 145;
		this.Controls.Find("CheckBox3", true)[0].Text = "Обновлять ед.";
		this.Controls.Find("CheckBox10", true)[0].Width = 260;
		this.Controls.Find("CheckBox10", true)[0].Text = "Автосохранение";
		this.Controls.Find("LinkLabel2", true)[0].Left = 165;
		this.Controls.Find("LinkLabel2", true)[0].Width = 150;
		this.Controls.Find("LinkLabel2", true)[0].Text = "Настройки";
		this.Controls.Find("GroupBox2", true)[0].Left = 360;
		this.Controls.Find("GroupBox2", true)[0].Width = 430;
		this.Controls.Find("CheckBox7", true)[0].Width = 240;
		this.Controls.Find("CheckBox7", true)[0].Text = "Пропускать read-only";
		this.Controls.Find("CheckBox4", true)[0].Width = 240;
		this.Controls.Find("Label2", true)[0].Width = 310;
		this.Controls.Find("RadioButton2", true)[0].Width = 170;
		this.Controls.Find("GroupBox3", true)[0].Left = 360;
		this.Controls.Find("GroupBox3", true)[0].Width = 430;
		this.Controls.Find("TextBox1", true)[0].Width = 385;
		this.Controls.Find("Button1", true)[0].Left = 395;
		this.Controls.Find("CheckBox8", true)[0].Left = 300;
		this.Controls.Find("CheckBox8", true)[0].Width = 100;
		this.Controls.Find("Label3", true)[0].Width = 220;
		this.Controls.Find("TableLayoutPanel1", true)[0].Left = 320;
		this.Controls.Find("TableLayoutPanel1", true)[0].Width = 490;
		this.Controls.Find("Save_Failed", true)[0].Text = "Не сохран.";
		this.Controls.Find("Save_Changed", true)[0].Text = "Изменённые";
	}
