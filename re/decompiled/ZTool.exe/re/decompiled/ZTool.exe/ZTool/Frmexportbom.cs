...
public class Frmexportbom : Form
{
	...
	private void InitializeComponent()
	{
		...
		this.RadioButton3.Text = "Только верхний";
		...
		this.lockratio.Text = "Сохранять пропорции (4:3)";
		...
		this.Propertylink.Text = "Выражения свойств";
		...
		this.Propertyvalue.Text = "Значения свойств";
		...
		this.marknodrw.Text = "Без чертежей";
		...
		this.includetop.Text = "Включая верхний";
		...
		this.autocolumnwidth.Text = "Автоширина";
		...
		this.MinimumSize = new System.Drawing.Size(1160, 560);
		this.Controls.Find("GroupBox5", true)[0].Width = 410;
		this.Controls.Find("bomsettinglist", true)[0].Width = 392;
		this.Controls.Find("TableLayoutPanel2", true)[0].Width = 394;
		this.Controls.Find("add", true)[0].Width = 100;
		this.Controls.Find("add", true)[0].Text = "Добавить";
		this.Controls.Find("edit", true)[0].Width = 130;
		this.Controls.Find("edit", true)[0].Text = "Переименовать";
		this.Controls.Find("del", true)[0].Width = 100;
		this.Controls.Find("del", true)[0].Text = "Удалить";
		this.Controls.Find("Button3", true)[0].Left = 1114;
		this.Controls.Find("Label1", true)[0].Left = 430;
		this.Controls.Find("Label1", true)[0].Width = 150;
		this.Controls.Find("ComboBox1", true)[0].Left = 585;
		this.Controls.Find("ComboBox1", true)[0].Width = 520;
		this.Controls.Find("GroupBox1", true)[0].Left = 430;
		this.Controls.Find("GroupBox1", true)[0].Width = 160;
		this.Controls.Find("RadioButton3", true)[0].Width = 140;
		this.Controls.Find("RadioButton4", true)[0].Width = 130;
		this.Controls.Find("GroupBox4", true)[0].Left = 605;
		this.Controls.Find("GroupBox4", true)[0].Width = 220;
		this.Controls.Find("Propertyvalue", true)[0].Width = 180;
		this.Controls.Find("Propertylink", true)[0].Width = 180;
		this.Controls.Find("includetop", true)[0].Width = 160;
		this.Controls.Find("GroupBox2", true)[0].Left = 840;
		this.Controls.Find("GroupBox2", true)[0].Width = 310;
		this.Controls.Find("RuleList", true)[0].Width = 324;
		this.Controls.Find("GroupBox3", true)[0].Left = 430;
		this.Controls.Find("GroupBox3", true)[0].Width = 390;
		this.Controls.Find("lockratio", true)[0].Width = 250;
		this.Controls.Find("ByRuler", true)[0].Left = 840;
		this.Controls.Find("ByRuler", true)[0].Width = 78;
		this.Controls.Find("ByFilter", true)[0].Left = 930;
		this.Controls.Find("ByFilter", true)[0].Width = 78;
		this.Controls.Find("TableLayoutPanel1", true)[0].Left = 860;
		this.Controls.Find("TableLayoutPanel1", true)[0].Width = 292;
		this.Controls.Find("Button1", true)[0].Width = 80;
		this.Controls.Find("Apply_Button", true)[0].Width = 95;
		this.Controls.Find("OK_Button", true)[0].Width = 80;
	}
	...
	private void Apply_Button_Click(object sender, EventArgs e)
	{
		...
		{
			text = bomsettinglist.SelectedItem.ToString();
		}
		if (Operators.CompareString(text.Trim(), "", TextCompare: false) != 0)
		{
			int num = CConfigMng.Config.bomsettings.FindIndex([SpecialName] (bomsetting s) => s.name.Equals(text, StringComparison.OrdinalIgnoreCase));
			if (num >= 0)
			{
				CConfigMng.Config.bomsettings[num] = createbomsetting(text);
	...
	private void Frmexportbom_Load(object sender, EventArgs e)
	{
		...
		List<string> list = CConfigMng.Config.bomsettings.Select([SpecialName] (bomsetting s) => s.name).Distinct(StringComparer.InvariantCultureIgnoreCase).ToList();
	...
	private void bomsettinglist_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		checked
		{
			...
			int num3 = 0;
			_Closure_0024__30._Closure_0024__31 closure_0024__ = default(_Closure_0024__30._Closure_0024__31);
			while (true)
			{
				int num4 = num3;
				int num5 = num2;
				if (num4 <= num5)
				{
					closure_0024__ = new _Closure_0024__30._Closure_0024__31(closure_0024__);
					closure_0024__._0024VB_0024Local_name = Conversions.ToString(RuleList.Items[num3]);
					int num6 = bomsetting2.RulesList.FindIndex(closure_0024__._Lambda_0024__67);
					if (num6 >= 0)
					{
	...
	{
		string text = Interaction.InputBox("Введите имя схемы");
		if (Operators.CompareString(text.Trim(), "", TextCompare: false) == 0)
		{
			return;
		}
		...
		bomsettinglist.Items.Add(text);
		CConfigMng.Config.bomsettings.Add(createbomsetting(text));
		CConfigMng.SaveConfig();
		try
		{
	...
	private void edit_Click(object sender, EventArgs e)
	{
		...
		string text2 = Interaction.InputBox("Введите имя правила", "", text);
		if (Operators.CompareString(text2.Trim(), "", TextCompare: false) != 0 && Operators.CompareString(text2, text, TextCompare: false) != 0 && 0 == 0)
		{
			int num2 = CConfigMng.Config.bomsettings.FindIndex([SpecialName] (bomsetting s) => s.name.Equals(text2, StringComparison.OrdinalIgnoreCase));
			if (num2 < 0)
			{
				bomsetting bomsetting2 = CConfigMng.Config.bomsettings[num];
				bomsetting2.name = text2;
				CConfigMng.Config.bomsettings[num] = bomsetting2;
				bomsettinglist.Items[bomsettinglist.SelectedIndex] = text2;
			}
			else
			{
				MessageBox.Show(this, "Имя «" + text2 + "» уже существует, выберите другое имя", "Информация", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
		}
	}
