...
'  совпадать с <propname> / видимыми колонками в SWTools.settings.
'
...
'  конфигурации — чтобы SWTools гарантированно их прочитал.
'
'  ЗАПУСК:
...
' --- Имена свойств (должны 1:1 совпадать с <propname> в SWTools.settings).
