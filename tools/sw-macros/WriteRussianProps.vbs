...
'  пользовательские свойства с РУССКИМИ (ЕСКД) именами, под которые
'  настроен маппинг в ZTool.settings (<namemappinglist>).
'
...
' --- Имена свойств (должны 1:1 совпадать с <mappingname> в ZTool.settings) ---
